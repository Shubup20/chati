...
const VoiceRecorder = () => {
  ...
  const recorderControls = useAudioRecorder(
    ...
    (err) => console.log(err) //onNotAlllowedOfNotFound
  );
      ...
      >
        ...
        >
          ...
          <div className="flex flex-row items-center space-x-4 w-full mt-8">
            ...
            <button
              onClick={() => dispatch(ToggleAudioModal(false))}
              className="w-full bg-transparent border border-red rounded-lg p-2 text-red"
            >
              Cancel
            </button>
          </div>
